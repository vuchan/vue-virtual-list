...
const STR_OR_FN_TYPE = PropTypes.oneOfType([PropTypes.string, PropTypes.func])
...
export const TableProps = {
  size: PropTypes.oneOf(['default', 'middle', 'small', 'large']).def('default'),
  locale: TableLocale,
  ...
  // whether use Virtual list to handle big list render
  ...
  // TODO: NEW, still unused now
  // true 展开所有
  // number 展开指定 number 深度
  expandDepth: PropTypes.oneOfType([PropTypes.bool, PropTypes.number]).def(
    true
  ),

  // $slots or just function? () => VNode
  title: PropTypes.func,
  footer: PropTypes.func,

  loading: PropTypes.oneOfType([
    // PropTypes.shape(SpinProps).loose,
    PropTypes.bool
  ]).def(false),
  ...
  expandIconAsCell: PropTypes.bool.def(false),
